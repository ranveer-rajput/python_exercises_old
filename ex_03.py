...
run_test(False, 100, [12, 45, 7, 23, 56, 89, 34], 5, "NotFoundTest", "Please check your logic correctly")

run_test(False, -1, [], 10, "EmptyListTest", "When numbers is an empty list the output should be `False`")
