...
run_test(9, [4,1,9,8], 10, "BigNumberTest", "Please check your logic to return the correct largest number")

run_test(-1,[], 5, "EmptyListTest", "When `numbers` is an empty list, the largest number should be `-1`")
